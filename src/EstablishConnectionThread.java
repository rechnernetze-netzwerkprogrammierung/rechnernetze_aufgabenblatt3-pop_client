...
public class EstablishConnectionThread extends Thread {
    ...
    public void run() {
        try {
            System.out.println("EstablishConnectionThread: connecting ...");
            clientSocket = new Socket("127.0.0.1", 8001);
            System.out.println("EstablishConnectionThread: connected");
            System.out.println("EstablishConnectionThread: setting up communication threads ...");
            ...
            System.out.println("EstablishConnectionThread: communication threads running ...");
        } catch (Exception e) {
            System.out.println("EstablishConnectionThread: some error occurred");
            e.printStackTrace();
        }
    }
}
